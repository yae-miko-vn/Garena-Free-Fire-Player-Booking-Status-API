...
def execute_command_all():
    ...
    if command.startswith('/nr='):
        ...
        ghost_names = {
            "4146829485": ghost_name,
            "4143498431": ghost_name, 
            "4146769736": ghost_name,
            "4144498636": ghost_name,
            "4049472315": ghost_name
        }
    ...
    # Handle /bngx command
        ...
        ghost_names = {
    "4146829485": "YOUR TEXT 1",
    "4143498431": "YOUR TEXT 2",
    "4146769736": "YOUR TEXT 3",
    "4144498636": "YOUR TEXT 4",
    "4049472315": "YOUR TEXT 5"
}
